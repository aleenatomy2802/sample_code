...
int main() {
    ...
    cout << "Factorial of 5: " << RecursiveAlgorithms::factorial(5) << endl;

    // Demonstrating the Fibonacci function
    cout << "Fibonacci of 5: " << RecursiveAlgorithms::fibonacci(5) << endl;

    // Demonstrating the sum of natural numbers
    cout << "Sum of first 5 natural numbers: " << RecursiveAlgorithms::sumOfNaturalNumbers(5) << endl;

    // Demonstrating power calculation
    cout << "2 raised to the power 3: " << RecursiveAlgorithms::power(2, 3) << endl;

    // Demonstrating GCD (Greatest Common Divisor) calculation
    cout << "GCD of 48 and 18: " << RecursiveAlgorithms::gcd(48, 18) << endl;
